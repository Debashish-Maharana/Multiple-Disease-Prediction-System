...
import joblib  # used for saving & loading your trained ML model.
import time
# Loading our ML Models.
# model which will predict Heart Disease
heart_disease_predict_model = joblib.load(open("/Users/debashish/ML Projects/heart_disease_prediction/heart_disease_prediction_model.sav", 'rb'))
# model which will predict Diabetes
diabetes_predict_model = joblib.load(open("/Users/debashish/ML Projects/Diabetes_Prediction/Diabetes_prediction_model.sav", 'rb'))
